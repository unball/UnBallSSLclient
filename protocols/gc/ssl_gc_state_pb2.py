...
Foul = _reflection.GeneratedProtocolMessageType('Foul', (_message.Message,), dict(
  DESCRIPTOR = _FOUL,
  __module__ = 'ssl_gc_state_pb2'
...
ProposalGroup = _reflection.GeneratedProtocolMessageType('ProposalGroup', (_message.Message,), dict(
...
ShootoutState = _reflection.GeneratedProtocolMessageType('ShootoutState', (_message.Message,), dict(

  NumberOfAttemptsEntry = _reflection.GeneratedProtocolMessageType('NumberOfAttemptsEntry', (_message.Message,), dict(
